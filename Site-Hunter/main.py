...
api_id = '17428740' # Keep this as it is 
api_hash = 'c3dc0c1e9e83a7896c9cd60591f3d9b4' # same heree
client_token = '7427022947:AAEzPrcvQM00LbrsBGDbWcaMiuOnENFVkMA'

admin_ids = [1226290399]  # Example admin IDs
...
✨
 ...
 🚀
    ...
    time.sleep(1.5)
    url = 'https://t.me/Noir_Tempest_001'
    buttons = [
        [Button.inline('Cmds', b'cmd'),
         Button.url('Admin', url)]
    ]
    textd = f"""
        ...
        if '.' in rw:
            ...
            if not website_url.startswith(("http://", "https://")):
                ...
                if "Error" in payment_gateways:
                    ...
                    await edit.edit(f""" ┏━━━━━━━⍟\n┃ 𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 𝗳𝗲𝘁𝗰𝗵𝗲𝗱 ✅\n┗━━━━━━━━━━━━⊛\n 𝗦𝗶𝘁𝗲 -» `{domain}`\n• 𝗚𝗮𝘁𝗲𝘄𝗮𝘆𝘀 ➜ unknown\n━━━━━━━━━━━━━━━\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐓𝐢𝐦𝐞 𝐓𝐚𝐤𝐞𝐧 : `{rounded_time_taken}``s`\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐁𝐨𝐭 [](https://t.me/Sitehunter_maniac_bot)\n❝ ━━━━・{ch}・━━━━ ❞""")
                else:
                    ...
                    if event.sender.id in pre:
                        ...
                        if credit ==0:
                            await event.respond('**Credits Finished! Try /refresh** or \nBuy 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 for Unlimited usage 👑.\n𝗦𝗵𝗼𝗽 ➜ [Knock admin](https://t.me/Noir_Tempest_001)', reply_to=event)
                        else:
                            user = event.sender
                            checked = f"[{user.first_name}](tg://user?id={user.id})" if user.username else user.first_name
                            ch_name = '𝙉𝙤𝙞𝙧'
